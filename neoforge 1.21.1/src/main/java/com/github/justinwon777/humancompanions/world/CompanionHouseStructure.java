...
public class CompanionHouseStructure extends Structure {
    ...
    public static final MapCodec<CompanionHouseStructure> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(CompanionHouseStructure.settingsCodec(instance),
                    ...
                    com.mojang.serialization.Codec.intRange(0, 7).fieldOf("size").forGetter(structure -> structure.size),
                    HeightProvider.CODEC.fieldOf("start_height").forGetter(structure -> structure.startHeight),
                    Heightmap.Types.CODEC.optionalFieldOf("project_start_to_heightmap").forGetter(structure -> structure.projectStartToHeightmap),
                    com.mojang.serialization.Codec.intRange(1, 128).fieldOf("max_distance_from_center").forGetter(structure -> structure.maxDistanceFromCenter)
