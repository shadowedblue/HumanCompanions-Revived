...
public class Archer extends AbstractHumanCompanionEntity implements RangedAttackMob {
    ...
    public void performRangedAttack(LivingEntity p_32141_, float p_32142_) {
        ...
        if (this.getMainHandItem().getItem() instanceof net.minecraft.world.item.BowItem)
            abstractarrow = ((net.minecraft.world.item.BowItem)this.getMainHandItem().getItem()).customArrow(abstractarrow, itemstack, this.getMainHandItem());
    ...
    protected AbstractArrow getArrow(ItemStack p_32156_, float p_32157_) {
        return ProjectileUtil.getMobArrow(this, p_32156_, p_32157_, this.getMainHandItem());
    }
