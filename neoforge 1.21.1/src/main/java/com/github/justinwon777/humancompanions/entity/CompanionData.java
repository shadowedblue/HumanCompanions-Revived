...
//            Items.RABBIT_STEW
    ...
    public static ResourceLocation[][] skins = new ResourceLocation[][] {
            new ResourceLocation[] {
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/medieval-man-hugh.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/alexandros.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/cyrus.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/diokles.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/dion.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/georgios.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/ioannis.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/medieval-peasant-schwaechlich.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/medieval-peasant-without-vest.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/medieval-peasant-with-vest-on.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/panos.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/viking-blue-tunic.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/cronos-jojo.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/medieval-man-alard.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/peasant-ginger.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/townsman-green-tunic.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/polish-farmer.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/peasant.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/rustic-farmer.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/male/medieval-villager.png"),
            },
            new ResourceLocation[] {
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/a-rogue-i-guess.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/deidre-gramville.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/deidre-gramville2.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/eleora-halle.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/fantastic-blue.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/ftu-emma.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/girl-medieval-peasant.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/medieval-barmaid.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/runaway.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/shannon-flux.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/the-traveller.png"),
                    ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "textures/entities/female/x-ayesha.png"),
            }
    };
