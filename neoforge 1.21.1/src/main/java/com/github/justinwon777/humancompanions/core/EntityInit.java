...
public final class EntityInit {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Knight>> Knight =
            ENTITIES.register("knight", () -> EntityType.Builder.of(Knight::new, MobCategory.AMBIENT)
                    .sized(0.6F, 1.8F)
                    .build(ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "knight").toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Archer>> Archer =
            ENTITIES.register("archer", () -> EntityType.Builder.of(Archer::new, MobCategory.AMBIENT)
                    .sized(0.6F, 1.8F)
                    .build(ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "archer").toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Arbalist>> Arbalist =
            ENTITIES.register("arbalist", () -> EntityType.Builder.of(Arbalist::new, MobCategory.AMBIENT)
                    .sized(0.6F, 1.8F)
                    .build(ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "arbalist").toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Axeguard>> Axeguard =
            ENTITIES.register("axeguard", () -> EntityType.Builder.of(Axeguard::new, MobCategory.AMBIENT)
                    .sized(0.6F, 1.8F)
                    .build(ResourceLocation.fromNamespaceAndPath(HumanCompanions.MOD_ID, "axeguard").toString()));
}
