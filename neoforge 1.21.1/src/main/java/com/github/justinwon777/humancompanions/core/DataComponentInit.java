...
public class DataComponentInit {
    ...
    public static final DeferredRegister<DataComponentType<?>> DATA_COMPONENTS =
            DeferredRegister.create(Registries.DATA_COMPONENT_TYPE, HumanCompanions.MOD_ID);

    /** Stored on Companion Recall item: which companion (and name) this recall is bound to. */
    ...
    public record BoundCompanionData(UUID companionId, String companionName) {
        ...
        /** Encode UUID as string, then name. */
